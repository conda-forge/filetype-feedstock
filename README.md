...
All platforms: [![Circle CI](https://circleci.com/gh/conda-forge/filetype-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/filetype-feedstock)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/filetype/badges/version.svg)](https://anaconda.org/conda-forge/filetype)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/filetype/badges/downloads.svg)](https://anaconda.org/conda-forge/filetype)
...
Once the `conda-forge` channel has been enabled, `filetype` can be installed with:

```
conda install filetype
```

It is possible to list all of the versions of `filetype` available on your platform with:
